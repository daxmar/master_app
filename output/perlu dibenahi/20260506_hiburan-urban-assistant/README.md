# Hiburan Urban Assistant

Aplikasi hiburan urban assistant yang menyatukan tema Hiburan, dengan nuansa Urban dan fungsi VR. Dibangun sebagai prototype sederhana menggunakan Rust untuk mengeksplorasi ide kreatif dan kegunaan sehari-hari.
...
## Cara Menjalankan
```
# Buka folder proyek dan jalankan kode sesuai bahasa Rust
```
