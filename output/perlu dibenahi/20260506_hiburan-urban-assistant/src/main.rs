...
struct HiburanUrbanAssistantApp {
    title: String,
    themes: Vec<String>,
    features: Vec<String>,
    data_file: String,
...
impl HiburanUrbanAssistantApp {
    fn new() -> Self {
        Self {
            title: "Hiburan Urban Assistant".to_string(),
            themes: vec!["Hiburan".to_string(), "Urban".to_string(), "VR".to_string()],
...
fn main() {
    let app = HiburanUrbanAssistantApp::new();
    app.main_menu();
}
