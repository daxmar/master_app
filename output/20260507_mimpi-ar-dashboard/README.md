...
Aplikasi mimpi ar dashboard yang menyatukan tema Komunikasi, dengan nuansa Mimpi dan fungsi AR. Dibangun sebagai prototype sederhana menggunakan JavaScript untuk mengeksplorasi ide kreatif dan kegunaan sehari-hari.
...
## Cara Menjalankan
```
# Buka folder proyek dan jalankan kode sesuai bahasa JavaScript
```
